...
// Red, semi-transparent; brighter when selected (8-bit alpha for setColors32).
...
class OffLimitsZoneShape extends Element {
    ...
    constructor() {
        ...
        this.pivot = new Entity('offLimitsZone');
    }
    ...
    // Fill the four quad vertices with red at the current selection alpha.
    private writeColors() {
